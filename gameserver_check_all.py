    ...
    for service in services:
        ...
        if gameserver:
            ...
            properties = {
                ...
                "Priority": "🚕 **{}**".format(', '.join(gameserver.get("settings", {}).get('general', {}).get('priority', '').splitlines() or ['None'])),
                "Whitelist": "📜 **{}**".format(', '.join(gameserver.get("settings", {}).get('general', {}).get('whitelist', '').splitlines() or ['None'])),
